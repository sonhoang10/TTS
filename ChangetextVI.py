...
def changenumvi(textnumchange):
    ...
    def two_digit_number(n): #10a #Thực hiện trả về từ một đến chín mươi chín. 
        ...
        else: #Thực hiện trả về hai mười, hai mốt,...,chín mươi chín nếu n nhỏ hơn 99
    ...
    def group_to_vietnamese(n): #9 Hàm này dùng để gọi những hàm khác theo những điều kiện dưới
    ...
    def number_to_vietnamese(n): #7 # Hàm tổng để chuyển số thành văn bản
        ...
        while n > 0: # Khi số còn lớn hơn 0
            ...
            if part != 0: # Nếu phần không phải là 0
                part_str = group_to_vietnamese(part) #8 # Chuyển đổi phần này thành văn bản tiếng Việt
